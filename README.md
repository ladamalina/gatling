...
* `3.11.1`, `latest` ([Dockerfile](https://github.com/ladamalina/gatling/blob/master/3.11.1/Dockerfile))
* `3.11.0` ([Dockerfile](https://github.com/ladamalina/gatling/blob/master/3.11.0/Dockerfile))
* `3.10.5` ([Dockerfile](https://github.com/ladamalina/gatling/blob/master/3.10.5/Dockerfile))
